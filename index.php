...
if($result)
    ...
    {
        echo "Record deletion failed becaues of ->" .mysqli_error($conn);
    }
...
$result=mysqli_query($conn,$sql);
 if($result)
    ...
    {
        echo "Record updation failed becaues of ->" .mysqli_error($conn);
    }
    ...
    {
        echo "Record insertion failed becaues of ->" .mysqli_error($conn);
    }
  }
  }
}
...
<html lang="en">
  <head>
    ...
    <!-- CHANGED: Use jQuery DataTables v1 CSS (not v2) so jQuery plugin API works -->
...
<hr>
    ...
    <!-- SCRIPTS: order matters. jQuery first, then DataTables (jQuery plugin), then Bootstrap -->
    <!-- CHANGED: Added jQuery and switched DataTables to v1 (jQuery plugin) -->
    ...
    <!-- CHANGED: correct ready syntax and initialize after table is in DOM -->
   <script>
